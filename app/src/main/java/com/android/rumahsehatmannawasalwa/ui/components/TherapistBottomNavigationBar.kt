...
fun TherapistBottomNavigationBar(navController: NavController) {
    val items = listOf(
        ...
        BottomNavItem("Jadwal", "therapist_schedule", Icons.Default.Event),
        BottomNavItem("Profil", "profile", Icons.Default.Person) // Reuse Profil Pasien
    )
